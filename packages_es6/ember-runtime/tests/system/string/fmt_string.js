...
test("'Hello %@ %@'.fmt('John', 'Doe') => 'Hello John Doe'", function() {
  equal(EmberStringUtils.fmt('Hello %@ %@', ['John', 'Doe']), 'Hello John Doe');
...
test("'Hello %@2 %@1'.fmt('John', 'Doe') => 'Hello Doe John'", function() {
  equal(EmberStringUtils.fmt('Hello %@2 %@1', ['John', 'Doe']), 'Hello Doe John');
  if (Ember.EXTEND_PROTOTYPES) {
...
test("'%@08 %@07 %@06 %@05 %@04 %@03 %@02 %@01'.fmt('One', 'Two', 'Three', 'Four', 'Five', 'Six', 'Seven', 'Eight') => 'Eight Seven Six Five Four Three Two One'", function() {
  equal(EmberStringUtils.fmt('%@08 %@07 %@06 %@05 %@04 %@03 %@02 %@01', ['One', 'Two', 'Three', 'Four', 'Five', 'Six', 'Seven', 'Eight']), 'Eight Seven Six Five Four Three Two One');
...
test("'data: %@'.fmt({id: 3}) => 'data: {id: 3}'", function() {
  equal(EmberStringUtils.fmt('data: %@', [{id: 3}]), 'data: {id: 3}');
  if (Ember.EXTEND_PROTOTYPES) {
