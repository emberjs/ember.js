...
test("with normal string", function() {
  deepEqual(EmberStringUtils.underscore('my favorite items'), 'my_favorite_items');
...
test("with dasherized string", function() {
  deepEqual(EmberStringUtils.underscore('css-class-name'), 'css_class_name');
  if (Ember.EXTEND_PROTOTYPES) {
...
test("does nothing with underscored string", function() {
  deepEqual(EmberStringUtils.underscore('action_name'), 'action_name');
  if (Ember.EXTEND_PROTOTYPES) {
...
test("with camelcased string", function() {
  deepEqual(EmberStringUtils.underscore('innerHTML'), 'inner_html');
  if (Ember.EXTEND_PROTOTYPES) {
