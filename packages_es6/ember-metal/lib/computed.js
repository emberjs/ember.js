...
if (Ember.FEATURES.isEnabled('composable-computed-properties')) {
  ...
  ComputedPropertyPrototype.toString = function() {
    ...
    return Descriptor.prototype.toString.apply(this, arguments);
  };
}
...
ComputedPropertyPrototype.set = function(obj, keyName, value) {
  ...
  if (this._readOnly) {
    throw new Error('Cannot Set: ' + keyName + ' on: ' + Ember.inspect(obj));
  }
...
if (Ember.FEATURES.isEnabled('composable-computed-properties')) {
  ...
  // composition
  computed.normalizeDependentKey = normalizeDependentKey;
  computed.normalizeDependentKeys = normalizeDependentKeys;

  // ES6TODO: Move this out with Ember.computed
...
if (Ember.FEATURES.isEnabled('composable-computed-properties')) {
  computed.literal = function (value) {
