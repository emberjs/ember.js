...
| ---------------------------------------------------------------- | ------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Classic curly components                                         | PASS                           | 0.0.67-verified: curly-component suites 207/0.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| Glimmer / Octane class components                                | PASS                           | 0.0.67-verified: Glimmerish 44/0. Depends on `@glimmer/component` shim — see §7.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Template-only components                                         | PASS                           | 0.0.67-verified: 11/0.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| Tracked properties & reactivity                                  | PASS                           | 0.0.67-verified: tracked/reactivity 258/0. Compat layer re-exports the `@glimmer/validator` surface; 19 files in `-internals/metal` route through the seam (§5.3).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `{{#each}}`                                                      | PASS                           | 0.0.67-verified: 575/0.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `{{#if}}`                                                        | PASS                           | 0.0.67-verified: 868/0.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `{{#let}}`                                                       | PASS                           | 0.0.67-verified: let-test suite 20/0.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `{{outlet}}`                                                     | PASS                           | 0.0.67-verified: outlet 31/0; nested and engine outlets covered by the engines suite (82/0).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `Router`, `LinkTo`, `router-service`                             | PASS                           | 0.0.67-verified: 111/0 (Route/LinkTo/router-service); broader routing ~861/0 including QueryParams 218/0, Controller 71/0, transitions 257/0. `-internals/routing` covered.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `{{mount}}` / Engines                                            | PASS                           | 0.0.67-verified: engine mounting + engine outlets 82/0. (Lazy engines / bundle-split asset maps not separately exercised.)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `{{component}}` curried with dynamic positional + named args     | PASS                           | 0.0.67-verified: dynamic/contextual/component-helper 137/0, including the `undefined`→value dynamic-type swap (dynamic-component suite green).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| Modifiers (`{{on}}`, custom modifiers, `ember-render-modifiers`) | PASS                           | 0.0.67-verified: 190/0 (the 3 `Custom Modifier Manager 3.22` fails under the filtered probe are a subset-ordering artifact — green in the full gate).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Helpers (classic `compute`, class-based, Octane function-based)  | PASS                           | 0.0.67-verified: Helpers test 1175/0.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Ember Data reactivity                                            | UNTESTED                       | Not testable in-repo as-is: `packages/demo` has orphan `@ember-data/model` scaffolding (`models/person.ts`, `services/store.ts`) but `@ember-data/*` is not installed/imported. The reactivity PRIMITIVE Ember Data rides on (`@tracked` via the `@glimmer/validator` tag seam) is already PASS, so the risk is Ember Data's package glue, not the signal mechanism. Plan: add `@ember-data/*` to a test package, render a tracked `attr`/`hasMany`, mutate via `store.push`, assert DOM updates (~2-3 days).                                                                                                                                                         |
| FastBoot / SSR rehydration                                       | PARTIAL                        | The rehydration suite is green (433/0) and the GXT `RehydrationDelegate` + per-request `withRootContext` seam are implemented — but the delegate RE-RENDERS client-side against a fresh cursor (not true node-reuse; it reports a fabricated `clearedNodes`), blocked by GXT's `data-node-id` markers only emitting under `IN_SSR_ENV` and `withRehydration` needing a `renderComponent` class. Functional FastBoot (SSR render + clean client boot) is ~2-4 weeks (DOM-provider factory to inject SimpleDOM + node-safe compat audit); TRUE node-reuse rehydration is ~4-6 weeks (additionally needs those blockers + a coordinated `@lifeart/gxt` release). See §7. |
| Ember Inspector integration                                      | UNSUPPORTED                    | Narrower gap than 'nothing exists': the render-tree DATA SOURCE works — `debug-render-tree.ts`'s `DebugRenderTree.capture()` backs `captureRenderTree(app)` and the `debug render tree` test is 13/0. Missing (no owner): the devtools-protocol component-tree adapter the browser extension talks to, the invalidation reporter (GXT's `$_ucw` dep graph isn't exposed), and the GXT-template source-map pipeline. An adapter would build ON the existing `captureRenderTree` foundation. See §9.                                                                                                                                                                    |
...
| Dynamic `mut` / two-way bindings through computed properties     | PASS                           | 0.0.67-verified: mut/two-way 228/0.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Observers / `didUpdate` lifecycle                                | PASS                           | 0.0.67-verified: 35/0.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `(hash)` / `(array)` helper identity across renders              | UNVALIDATED                    | Value correctness passes (hash 2/0, array 3/0), but the IDENTITY-stability concern is still uncovered: GXT closure evaluation may return fresh objects where Glimmer reused references, so anything relying on `===` in `didUpdateAttrs` / modifier arg comparison could silently over-invalidate. Needs an explicit identity-across-renders test before preview exits.                                                                                                                                                                                                                                                                                               |
| Named blocks, `has-block`, `has-block-params`                    | PASS                           | 0.0.67-verified: 448/0 (yield / has-block / named-block suites).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
