...
FragmentOpcodeCompiler.prototype.startTemplate = function(block) {
...
FragmentOpcodeCompiler.prototype.endTemplate = function(block) {
  if (block.length === 0) {
    this.opcode('empty');
  } else if (block.length === 1) {
    if (typeof block.children[0] === 'string') {
