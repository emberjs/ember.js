...
HydrationOpcodeCompiler.prototype.startTemplate = function(block) {
...
HydrationOpcodeCompiler.prototype.endTemplate = function(block) {
  distributePlaceholders(this.placeholders, this.opcodes);
  if (block.length === 1 && typeof block.children[0] !== 'string') {
    this.opcodes.shift();
    this.opcodes.pop();
  }
};
