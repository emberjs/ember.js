...
TemplateCompiler.prototype.startTemplate = function(block) {
  this.fragmentOpcodeCompiler.startTemplate(block);
  this.hydrationOpcodeCompiler.startTemplate(block);

  this.childTemplates.length = 0;
  var childCount = block.count;
  while(childCount--) {
    this.childTemplates.push(this.templates.pop());
  }
};

TemplateCompiler.prototype.endTemplate = function(block) {
  this.fragmentOpcodeCompiler.endTemplate(block);
  this.hydrationOpcodeCompiler.endTemplate(block);
