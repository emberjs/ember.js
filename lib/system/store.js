...
DS.Store = Ember.Object.extend({
  ...
  */
  ...
  _didCreateRecord: function(record, hash, dataCache, clientId, primaryKey, idMap) {
  ...
  didCreateRecords: function(type, array, hashes) {
    ...
    for (var i=0, l=get(array, 'length'); i<l; i++) {
      ...
      this._didCreateRecord(model, hash, data, clientId, primaryKey, idToClientIdMap);
    }
  },
  ...
  updateModelArrayFilter: function(array, type, filter) {
    var dataCache = this.clientIdToHashMap(type);
    var allClientIds = this.typeMapFor(type).clientIds, clientId, hash, proxy;
  ...
  clientIdList: function(type) {
    return this.typeMapFor(type).clientIds;
  },
