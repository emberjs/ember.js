...
DS.Model = Ember.Object.extend({
  ...
  transaction: null,
  _transaction: Ember.computed(function() {
    return get(this, 'transaction') || getPath(this, 'store.defaultTransaction');
  }).property('transaction').cacheable(),
  ...
  withTransaction: function(fn) {
    var transaction = get(this, '_transaction');
