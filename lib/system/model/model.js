...
var sendToStateManager = function(event) {
  return function() {
    var stateManager = get(this, 'stateManager');
    var args = [].slice.call(arguments);
    args = [event].concat(args);

    return stateManager.send.apply(stateManager, args);
  };
};
...
DS.Model = Ember.Object.extend({
  ...
  setData: sendToStateManager('setData'),
  ...
  deleteRecord: sendToStateManager('delete'),
  loadingData: sendToStateManager('loadingData'),
  willLoadData: sendToStateManager('willLoadData'),
  willCommit: sendToStateManager('willCommit'),
  waitingOn: sendToStateManager('waitingOn'),

  adapterDidUpdate: sendToStateManager('didUpdate'),
  adapterDidCreate: sendToStateManager('didCreate'),
  adapterDidDelete: sendToStateManager('didDelete'),
  wasInvalid: sendToStateManager('wasInvalid'),
