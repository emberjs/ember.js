...
module.exports = {
  init() {
    ...
    // treeForVendor
    //
    // TODO: the last thing in here is the prebuilt ember-template-compiler.js,
    // which we should distribute in the directory "vendor" so we avoid the
    // non-default naming scheme here.
  ...
  treeForAddonTestSupport(tree) {
    let packages = new Funnel(tree, { srcDir: 'packages', include: ['ember-testing/**'] });
