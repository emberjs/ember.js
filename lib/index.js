      ...
      if (useEmberModules) {
        ...
        return {
          ...
          'implicit-test-modules': [
            ...
            './dist/dev/packages/ember-testing/lib/adapters/qunit.js',
            './dist/dev/packages/ember-testing/lib/ext/application.js',
            './dist/dev/packages/ember-testing/lib/ext/rsvp.js',
            './dist/dev/packages/ember-testing/lib/helpers.js',
            './dist/dev/packages/ember-testing/lib/helpers/and_then.js',
            './dist/dev/packages/ember-testing/lib/helpers/current_path.js',
            './dist/dev/packages/ember-testing/lib/helpers/current_route_name.js',
            './dist/dev/packages/ember-testing/lib/helpers/current_url.js',
            './dist/dev/packages/ember-testing/lib/helpers/pause_test.js',
            './dist/dev/packages/ember-testing/lib/helpers/visit.js',
            './dist/dev/packages/ember-testing/lib/helpers/wait.js',
            './dist/dev/packages/ember-testing/lib/initializers.js',
            './dist/dev/packages/ember-testing/lib/public-api.js',
            './dist/dev/packages/ember-testing/lib/setup_for_testing.js',
            './dist/dev/packages/ember-testing/lib/test.js',
            './dist/dev/packages/ember-testing/lib/test/adapter.js',
            './dist/dev/packages/ember-testing/lib/test/helpers.js',
            './dist/dev/packages/ember-testing/lib/test/on_inject_helpers.js',
