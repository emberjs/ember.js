...
test("should add a sc-hidden className to views when isVisible is false", function() {
  var view = SC.View.create({
    isVisible: false
  });

  view.createElement();
  ok(view.$().hasClass('sc-hidden'), "the view has sc-hidden");

  view.set('isVisible', true);
  ok(!view.$().hasClass('sc-hidden'), "removes sc-hidden from the view when isVisible is true");
});
