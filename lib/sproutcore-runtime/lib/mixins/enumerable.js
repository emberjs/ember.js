...
require('sproutcore-runtime/system/enumerator');
...
SC._buildReducerFor = function(reducerKey, reducerProperty) {
  return SC.Function.property(function(key, value) {
...
SC.Reducers = /** @scope SC.Reducers.prototype */ {
  ...
  */
  reducedProperty: function(key, value, generateProperty) {
    ...
    if (!key || typeof key !== SC.T_STRING || key.charAt(0) !== '@') {
      return undefined ; // not a reduced property
    }
