...
SC.Observable = /** @scope SC.Observable.prototype */{
  ...
  set: function(key, value) {
    ...
    if (func && func.isProperty) {
      if (func.isCacheable) {
        ...
        // value.
        if (cache[func.lastSetValueKey] === value) {
          return this;
        } else {
      ...
      // unknownProperty. The default behavior of unknownProperty
      // is simply to set the key to the value.
      valueFromSet = this.unknownProperty(key, value) ;
  ...
  */
  ...
  /**
    ...
    If you override this method, make sure to return sc_super().
