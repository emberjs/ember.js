...
SC.Binding = /** @scope SC.Binding.prototype */{
  ...
  */
  _connect: function() {
    if (!this._connectionPending) { return; }
  ...
  */
  _computeBindingValue: function() {
    ...
    if (transformedVal === this._transformedBindingValue) { return false; }
  ...
  */
  ...
  /**
    ...
    @param {Boolean} [aFlag] Pass NO to set the binding back to two-way, default YES
    @returns {SC.Binding} this
  */
  ...
  */
  multiple: function(fromPath) {
    return this.from(fromPath).transform(function(value) {
      if (!SC.isArray(value)) { value = SC.none(value) ? [] : [value]; }
      return value;
    });
  },
  ...
  */
  ...
  toString: function() {
    var from = this._fromRoot ? "<%@>:%@".fmt(this._fromRoot,this._fromPropertyPath) : this._fromPropertyPath,
        to = this._toRoot ? "<%@>:%@".fmt(this._toRoot,this._toPropertyPath) : this._toPropertyPath,
        oneWay = this._oneWay ? '[oneWay]' : '';
