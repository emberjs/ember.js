...
Components update automatically when any data (component state or otherwise)
that influences their appearance changes.

In Glimmer VM, there is no built-in base `Component` class. User-facing objects
like this are supplied by a [component manager](#component-manager).
