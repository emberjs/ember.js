declare module '@ember/-internals/glimmer/lib/renderer' {
  ...
  export class DynamicScope implements GlimmerDynamicScope {
    view: View | null;
    outletState: Reactive<OutletState | undefined>;
    constructor(view: View | null, outletState: Reactive<OutletState | undefined>);
    child(): DynamicScope;
    get(key: 'outletState'): Reactive<OutletState | undefined>;
    set(
      key: 'outletState',
      value: Reactive<OutletState | undefined>
    ): Reactive<OutletState | undefined>;
  }
  class RootState {
