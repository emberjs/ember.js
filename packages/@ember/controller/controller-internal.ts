...
/**
  The internal counterpart to the public `ControllerMixin`. Ember's own
  ...
  @internal
*/
const InternalControllerMixin = InternalMixin.create(InternalActionHandler, {
...
export default InternalControllerMixin;
