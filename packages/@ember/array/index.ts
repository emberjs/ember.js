...
import type Enumerable from '@ember/enumerable';
import type MutableEnumerable from '@ember/enumerable/mutable';
...
export { uniqBy, removeAt } from '@ember/array/index-internal';
export { isArray };
...
const EmberArray = DeprecatedMixin.create(InternalEmberArrayMixin, {
  init() {
    this._super(...arguments);
    deprecateUntil(
      'The `EmberArray` mixin is deprecated. Use native arrays and array methods instead.',
      DEPRECATIONS.DEPRECATE_EMBER_ARRAY_MIXIN
    );
  },
});
...
const MutableArray = DeprecatedMixin.create(InternalMutableArrayMixin, {
  init() {
    this._super(...arguments);
    deprecateUntil(
      'The `MutableArray` mixin is deprecated. Use native arrays and array methods instead.',
      DEPRECATIONS.DEPRECATE_MUTABLE_ARRAY_MIXIN
    );
  },
});
...
const NativeArray = DeprecatedMixin.create(InternalNativeArrayMixin, {
  init() {
    this._super(...arguments);
    deprecateUntil(
      'The `NativeArray` mixin is deprecated. Use native arrays and array methods instead.',
      DEPRECATIONS.DEPRECATE_NATIVE_ARRAY_MIXIN
    );
  },
});
