...
this is text to force a diff of stuff
this is text to force a diff of stuff
this is text to force a diff of stuff
this is text to force a diff of stuff
this is text to force a diff of stuff
...
u attempted to set a default value for ${key} with the @tracked({ value: 'default' }) syntax. You can only use this syntax with classic classes. For native classes, you can use class initializers: @tracked field = 'default';`,
        isClassicDecorator
      );
