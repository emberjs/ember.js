...
import { type InternalFactory, type InternalOwner, setOwner } from '@ember/-internals/owner';
...
import { type DirtyableTag, consumeTag, createTag, dirtyTag } from '@glimmer/validator';
