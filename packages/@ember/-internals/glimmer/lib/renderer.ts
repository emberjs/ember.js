...
// Implemented by ComponentRootState (below) and ClassicRootState (in
// ./classic-renderer). A structural interface (rather than a union) keeps this
// module from depending on the classic rendering pipeline.
...
class ComponentRootState implements RendererRoot {
