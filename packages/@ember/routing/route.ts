...
class Route<Model = unknown> extends EmberObject implements IRoute {
  ...
  */
  ...
  /**
    ...
    @public
  */
  send<K extends keyof this>(
    name: K,
    ...args: MaybeParameters<K extends keyof this ? this[K] : never>
  ): MaybeReturnType<K extends keyof this ? this[K] : never>;
