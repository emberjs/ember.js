...
import type { SerializedTemplateWithLazyBlock } from '@glimmer/ember/interfaces';
import { setComponentTemplate } from '@glimmer/ember/manager';
import { templateFactory } from '@glimmer/ember/opcode-compiler';
