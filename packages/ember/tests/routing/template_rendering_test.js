...
moduleFor(
  ...
  class extends ApplicationTestCase {
    ...
    async [`Model passed via renderTemplate model is set as controller's model`](assert) {
      this.addTemplate(
        'bio',
    ...
    async ["The template is not re-rendered when the route's model changes"](assert) {
      this.router.map(function() {
