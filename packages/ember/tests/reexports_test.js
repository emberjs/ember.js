...
let allExports = [
  ...
  ['String.loc', 'ember-runtime', 'loc'],
  ['String.w', 'ember-runtime', 'w'],
  ['String.dasherize', 'ember-runtime', 'dasherize'],
  ['String.decamelize', 'ember-runtime', 'decamelize'],
  ['String.camelize', 'ember-runtime', 'camelize'],
  ['String.classify', 'ember-runtime', 'classify'],
  ['String.underscore', 'ember-runtime', 'underscore'],
  ['String.capitalize', 'ember-runtime', 'capitalize'],
