...
if (Ember.FEATURES.isEnabled("ember-runtime-min-by")) {
  ...
  suite.test('null returned for empty collection', function() {
    var obj = this.newObject([]),
        min = obj.minBy('a');
    equal(min, null);
  });

  suite.test('null returned if any element doesn\'t have provided property', function() {
  ...
  suite.test('null returned if all elements have property equal to null or undefined', function() {
    var arr = [{a: null},
               {a: null},
               {a: undefined},
