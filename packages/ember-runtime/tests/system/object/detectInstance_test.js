...
moduleFor(
  ...
  class extends AbstractTestCase {
    ['@test detectInstance detects instances correctly'](assert) {
      ...
      assert.ok(
        EmberObject.detectInstance(o),
        'o is an instance of EmberObject'
      );
      assert.ok(
        EmberObject.detectInstance(a),
        'a is an instance of EmberObject'
      );
      assert.ok(
        EmberObject.detectInstance(b),
        'b is an instance of EmberObject'
      );
      assert.ok(
        EmberObject.detectInstance(c),
        'c is an instance of EmberObject'
      );
