...
QUnit.test(
  'compact - returns arrangedContent without nulls and undefined',
  function(assert) {
...
QUnit.test(
  'lastIndexOf - returns last index of object in arrangedContent',
  function(assert) {
...
QUnit.test(
  'objectAtContent - returns object at index in arrangedContent',
  function(assert) {
...
QUnit.test(
  'objectsAt - returns objects at indices in arrangedContent',
  function(assert) {
    assert.deepEqual(
...
QUnit.test(
  'replace - mutating an arranged ArrayProxy is not allowed',
  function() {
    expectAssertion(() => {
      array.replace(0, 0, [3]);
...
QUnit.test(
  'replaceContent - does a standard array replace on content',
  function(assert) {
