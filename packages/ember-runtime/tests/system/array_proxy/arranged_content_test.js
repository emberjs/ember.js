...
moduleFor('ArrayProxy - arrangedContent', class extends AbstractTestCase {
  beforeEach() {
    run(() => {
...
moduleFor('ArrayProxy - arrangedContent matching content', class extends AbstractTestCase {
  beforeEach() {
    run(function() {
...
moduleFor('ArrayProxy - arrangedContent with transforms', class extends AbstractTestCase {
  beforeEach() {
    run(function() {
      array = ArrayProxy.extend({
...
moduleFor('ArrayProxy - with transforms', class extends AbstractTestCase {
  beforeEach() {
    run(function() {
      array = ArrayProxy.extend({
        objectAtContent(idx) {
