...
QUnit.test(
  'toString should be not be added as a property when calling toString()',
  function(assert) {
    let obj = new CoreObject({
      firstName: 'Foo',
      lastName: 'Bar'
...
QUnit.test(
  'should not trigger proxy assertion when retrieving a proxy with (GH#16263)',
  function(assert) {
...
QUnit.test(
  'should not trigger proxy assertion when probing for a "symbol"',
  function(assert) {
