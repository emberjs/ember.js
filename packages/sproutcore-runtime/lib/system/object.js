...
SC._detect_base = function _detect_base(func, parent, name) {
  return function invoke_superclass_method() {
    ...
    if (!base) {
      throw new SC.Error("No '" + name + "' method was found on the superclass");
    }
...
SC._object_extend = function _object_extend(base, ext, proto) {
  if (!ext) { throw new SC.Error("SC.Object.extend expects a non-null value. Did you forget to 'sc_require' something?  Or were you passing a Protocol to extend() as if it were a mixin?"); }
...
SC.Object.prototype = /** @scope SC.Object.prototype */{
  ...
  */
  superclass: function(args) {
    ...
    if (!caller) { throw new SC.Error("superclass cannot determine the caller method"); }
