...
SC.Enumerable = /** @scope SC.Enumerable.prototype */{
  ...
  */
  ...
  /**
    ...
    @param {Number} [start] Starting offset for the content change
  ...
  */
  firstObject: SC.Function.property(function() {
    ...
    // support arrays out of box
    if (this.objectAt) { return this.objectAt(0); }
  ...
  */
  lastObject: SC.Function.property(function() {
    ...
    // support arrays out of box
    if (this.objectAt) { return this.objectAt(len-1); }
  }),
  ...
  */
  forEach: function(callback, target) {
    ...
    var last = null, next, result, context = {}, idx;
  ...
  */
  find: function(callback, target) {
    ...
    this.breakableEach(function(item, i) {
      if (callback.call(target, item, i, this)) {
        result = item;
        return false;
      }
    }, this);
  ...
  */
  ...
  /**
    ...
    @param {Object...} [args] Arguments to pass as well.
