...
test("should invalidate computed property once to propagate binding", function() {
  var setCalls = 0;
  var getCalls = 0;
  var peopleWatcher;
  ...
  SC.run(function() {
    ...
    peopleWatcher = SC.Object.create({
  ...
  equals(getCalls, 1, "calls get once to propagate binding");
});
