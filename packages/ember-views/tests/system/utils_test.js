...
test("innerHTML for IE fix, original failing test in IE9", function() {
  // issue #2018
  // from http://jsbin.com/oruzor/1/edit and from collection_view_tests.js: 
  // 'empty views should be removed when content is added to the collection (regression, ht: msofaer)'
