...
import { TestEnvironment, HookIntrospection, curlyComponentDefinition, glimmerComponentDefinition } from "./support";
...
class Component extends EmberObject {
  ...
  public attrs; // passed by the component morph
