...
scenarios.forEach(function (scenario) {
  QUnit.module('The router (' + scenario.name + ')', {
  ...
  QUnit.test('Mapping adds named routes to the end', function (assert) {
  ...
  QUnit.test('Handling an invalid URL returns a rejecting promise', function (assert) {
  ...
  QUnit.test(
    'Handling a URL triggers model on the handler and passes the result into the setup method',
    function (assert) {
      assert.expect(4);
  ...
  QUnit.test('isActive should not break on initial intermediate route', function (assert) {
    assert.expect(1);
    router.intermediateTransitionTo('/posts/admin/1/posts');
    assert.ok(router.isActive('admin', '1'));
  });

  QUnit.test('Handling a URL passes in query params', async function (assert) {
    assert.expect(3);
    ...
    await router.handleURL('/index?sort=date&filter');
  ...
  QUnit.test('handleURL accepts slash-less URLs', function (assert) {
    assert.expect(1);
  ...
  QUnit.test('handleURL accepts query params', function (assert) {
    assert.expect(1);
  ...
  QUnit.test("redirect hook shouldn't get called on parent routes", async function (assert) {
    map(assert, function (match) {
    ...
    await router.transitionTo('other');
    assert.equal(appRedirects, 1);
  });

  QUnit.test(
    'when transitioning with the same context, setup should only be called once',
    async function (assert) {
      ...
      await router.transitionTo('postDetails', context);
  ...
  QUnit.test('basic route change events', function (assert) {
    assert.expect(11);
    map(assert, function (match) {
      match('/').to('index');
      match('/posts/:id').to('post', function (match) {
  ...
  QUnit.test('basic events with route metadata', function (assert) {
    assert.expect(10);
    map(assert, function (match) {
      match('/').to('index');
  ...
  QUnit.test('basic route change events with replacement', function (assert) {
    assert.expect(14);
    map(assert, function (match) {
      match('/').to('index');
      match('/posts/:id').to('post', function (match) {
  ...
  QUnit.test('basic route change events with nested replacement', function (assert) {
    assert.expect(12);
    map(assert, function (match) {
      match('/').to('index');
      match('/posts/:id').to('post', function (match) {
  ...
  QUnit.test('basic route change events with params', function (assert) {
    assert.expect(26);
    map(assert, function (match) {
      match('/').to('index');
  ...
  QUnit.test('top-level recognizeAndLoad url', function (assert) {
    map(assert, function (match) {
      match('/').to('index');
    });
  ...
  QUnit.test('top-level parameterized recognizeAndLoad', function (assert) {
    map(assert, function (match) {
  ...
  QUnit.test('nested recognizeAndLoad', function (assert) {
    routes = {
  ...
  QUnit.test('nested params recognizeAndLoad', function (assert) {
    routes = {
      postIndex: createHandler('postIndex'),
  ...
  QUnit.test('top-level QPs recognizeAndLoad', function (assert) {
    routes = {
      showAllPosts: createHandler('showAllPosts', {
        model() {
  ...
  QUnit.test('top-level params and QPs recognizeAndLoad', function (assert) {
    routes = {
  ...
  QUnit.test('unrecognized url rejects', function (assert) {
  ...
  QUnit.test('top-level recognize url', function (assert) {
    map(assert, function (match) {
      match('/').to('index');
    });
  ...
  QUnit.test('top-level recognize url with params', function (assert) {
    map(assert, function (match) {
      match('/posts/:id').to('post');
    });
  ...
  QUnit.test('nested recognize url', function (assert) {
    routes = {
      postIndex: createHandler('postIndex'),
      showPopularPosts: createHandler('showPopularPosts'),
    };
  ...
  QUnit.test('nested recognize url with params', function (assert) {
    routes = {
      postIndex: createHandler('postIndex'),
      showFilteredPosts: createHandler('showFilteredPosts'),
    };
  ...
  QUnit.test('top-level recognize url with QPs', function (assert) {
    map(assert, function (match) {
      match('/').to('index');
    });
  ...
  QUnit.test('nested recognize url with QPs', function (assert) {
    routes = {
      postIndex: createHandler('postIndex'),
      showPopularPosts: createHandler('showPopularPosts'),
    };
  ...
  QUnit.test('nested recognize url with QPs and params', function (assert) {
    routes = {
      postIndex: createHandler('postIndex'),
      showFilteredPosts: createHandler('showFilteredPosts'),
    };
  ...
  QUnit.test('unrecognized url returns null', function (assert) {
    map(assert, function (match) {
      match('/').to('index');
      match('/posts/:id').to('post');
    });
  ...
  QUnit.test('basic route change events with nested params', function (assert) {
    assert.expect(14);
    map(assert, function (match) {
      match('/').to('index');
  ...
  QUnit.test('basic route change events with query params', function (assert) {
    assert.expect(20);
    map(assert, function (match) {
      match('/').to('index');
      match('/posts/:id').to('post');
  ...
  QUnit.test('basic route to one with query params', function (assert) {
    assert.expect(8);
    map(assert, function (match) {
      match('/').to('index');
  ...
  QUnit.test('redirects route events', function (assert) {
    assert.expect(19);
    map(assert, function (match) {
      match('/').to('index');
      match('/posts', function (match) {
  ...
  QUnit.test('abort route events', function (assert) {
    assert.expect(19);
    map(assert, function (match) {
      match('/').to('index');
      match('/posts', function (match) {
  ...
  QUnit.test('abort query param only', function (assert) {
    assert.expect(6);
    map(assert, function (match) {
      match('/').to('index');
    });
  ...
  QUnit.test('always has a transition through the substates', function (assert) {
    map(assert, function (match) {
      match('/').to('index');
      match('/posts', function (match) {
        match('/:id').to('post');
  ...
  QUnit.test('error route events', function (assert) {
    map(assert, function (match) {
      match('/').to('index');
      match('/posts', function (match) {
        match('/:id').to('post');
  ...
  QUnit.test(
    "when transitioning to a new parent and child state, the parent's context should be available to the child's model",
    function (assert) {
      type Post = IModel;
  ...
  QUnit.test('handleURL: Handling a nested URL triggers each handler', function (assert) {
    assert.expect(37);
  ...
  QUnit.test('it can handle direct transitions to named routes', function (assert) {
    let allPosts = { all: true };
    let popularPosts = { popular: true };
  ...
  QUnit.test('replaceWith calls replaceURL', function (assert) {
    let updateCount = 0,
      replaceCount = 0;
  ...
  QUnit.test(
    'applyIntent returns a tentative state based on a named transition',
    async function (assert) {
      await router.transitionTo('/posts');
      let state = router.applyIntent('faq', []);
      assert.ok(state.routeInfos.length);
    }
  );

  QUnit.test('Moving to a new top-level route triggers exit callbacks', function (assert) {
    assert.expect(6);
  ...
  QUnit.test('transition.resolvedModels after redirects b/w routes', async function (assert) {
    ...
    return ignoreTransitionError(router.transitionTo('/peter'));
  });

  QUnit.test(
    'transition.resolvedModels after redirects within the same route',
    async function (assert) {
      ...
      await router.transitionTo('/posts/admin/1/posts');
    }
  );

  QUnit.test(
    `transition.to.find's callback is always called with defined routeInfo`,
    async function (assert) {
      type Application = { app: boolean } & IModel;
      ...
      await router.transitionTo('/peter/wagenet');
    }
  );

  QUnit.test(
    'Moving to the same route with a different parent dynamic segment re-runs model',
    async function (assert) {
      ...
      await router.transitionTo('/posts/admin/2/posts');
  ...
  QUnit.test(
    'Moving to a sibling route only triggers exit callbacks on the current route (when transitioned internally)',
    async function (assert) {
      assert.expect(8);
      ...
      await router.handleURL('/posts').then(function () {
  ...
  QUnit.test(
    'Moving to a sibling route only triggers exit callbacks on the current route (when transitioned via a URL change)',
    async function (assert) {
      assert.expect(7);
      ...
      await router.handleURL('/posts');

      expectedUrl = '/posts/filter/favorite';
      await router.handleURL(expectedUrl);
    }
  );

  QUnit.test('events can be targeted at the current handler', async function (assert) {
    assert.expect(2);
    ...
    await router.transitionTo('/posts/1');

    router.trigger('expand');
  });

  QUnit.test('event triggering is pluggable', function (assert) {
    routes = {
      showPost: createHandler('showPost', {
        enter: function () {
          assert.ok(true, 'The show post handler was entered');
  ...
  QUnit.test('Unhandled events raise an exception', function (assert) {
    router.handleURL('/posts/1');
  ...
  QUnit.test('events can be targeted at a parent handler', async function (assert) {
    assert.expect(3);
  ...
  QUnit.test('events can bubble up to a parent handler via `return true`', function (assert) {
    assert.expect(4);
  ...
  QUnit.test(
    "handled-then-bubbled events don't throw an exception if uncaught by parent route",
    async function (assert) {
      assert.expect(3);
  ...
  QUnit.test('events only fire on the closest handler', function (assert) {
    assert.expect(5);
  ...
  QUnit.test("Date params aren't treated as string/number params", function (assert) {
    assert.expect(1);
  ...
  QUnit.test('getSerializer takes precedence over handler.serialize', function (assert) {
    assert.expect(2);
  ...
  QUnit.test('the serializer method is unbound', function (assert) {
    assert.expect(1);
  ...
  QUnit.test('params are known by a transition up front', async function (assert) {
    assert.expect(2);
    ...
    await router.transitionTo('/posts/filter/sad', 'blorg');
  });

  QUnit.test(
    'transitionTo uses the current context if you are already in a handler with a context that is not changing',
    async function (assert) {
      let admin = { id: 47 },
        adminPost = { id: 74 };
      ...
      await router.transitionTo('adminPost', admin, adminPost);

      expectedUrl = '/posts/admin/47/posts/75';
      await router.transitionTo('adminPost', { id: 75 });
    }
  );

  QUnit.test('check for mid-transition correctness', async function (assert) {
    let posts: Dict<any> = {
      1: { id: 1 },
      2: { id: 2 },
      3: { id: 3 },
    ...
    await router.transitionTo('/posts/3');
  });

  QUnit.test(
    'tests whether arguments to transitionTo are considered active',
    async function (assert) {
      let admin = { id: 47 },
        adminPost = { id: 74 },
        posts: Dict<any> = {
  ...
  QUnit.test(
    'calling generate on a non-dynamic route does not blow away parent contexts',
    function (assert) {
      map(assert, function (match) {
  ...
  QUnit.test(
    'calling transitionTo on a dynamic parent route causes non-dynamic child context to be updated',
    async function (assert) {
      ...
      await router.transitionTo('/project/1');
      assert.deepEqual(
      ...
      await router.transitionTo('projectIndex', { project_id: '2' });
      assert.deepEqual(
        projectHandler.context,
        { project_id: '2' },
  ...
  QUnit.test(
    'reset exits and clears the current and target route handlers',
    async function (assert) {
      ...
      await router.transitionTo('/posts/all');
  ...
  QUnit.test(
    'any of the model hooks can redirect with or without promise',
    async function (assert) {
      assert.expect(26);
      ...
      async function testStartup(assert: Assert, firstExpectedURL?: string) {
        map(assert, function (match) {
          match('/').to('index');
          match('/about').to('about');
          match('/foo').to('foo');
        ...
        await ignoreTransitionError(router.transitionTo('/'));

        expectedUrl = '/borf';
        redirectTo = 'borf';

        await ignoreTransitionError(router.transitionTo('index'));
      }

      await testStartup(assert);
  ...
  QUnit.test(
    'transitionTo with a promise pauses the transition until resolve, passes resolved context to setup',
    async function (assert) {
      routes = {
        index: createHandler('index'),
        showPost: createHandler('showPost', {
  ...
  QUnit.test(
    "Errors shouldn't be handled after proceeding to next child route",
    async function (assert) {
      assert.expect(3);
      ...
      ignoreTransitionError(router.handleURL('/parent/articles'));
    }
  );

  QUnit.test(
    "Error handling shouldn't trigger for transitions that are already aborted",
    function (assert) {
      assert.expect(1);
      ...
      return ignoreTransitionError(router.handleURL('/slow_failure'));
    }
  );

  QUnit.test(
    'Transitions to the same destination as the active transition just return the active transition',
    function (assert) {
      assert.expect(1);
  ...
  QUnit.test('can redirect from error handler', function (assert) {
    assert.expect(4);
  ...
  QUnit.test('can redirect from setup/enter', function (assert) {
    assert.expect(5);
  ...
  QUnit.test(
    'redirecting to self from validation hooks should no-op (and not infinite loop)',
    function (assert) {
      assert.expect(2);
  ...
  QUnit.test('Transition#method(null) prevents URLs from updating', async function (assert) {
    assert.expect(1);
    ...
    await router.handleURL('/index').method(null);

    await router.transitionTo('about').method(null);
  });

  QUnit.test(
    'redirecting to self from enter hooks should no-op (and not infinite loop)',
    function (assert) {
      assert.expect(1);
  ...
  QUnit.test(
    'redirecting to child handler from validation hooks should no-op (and not infinite loop)',
    function (assert) {
      assert.expect(4);
  ...
  QUnit.test('transitionTo with named transition can be called at startup', function (assert) {
    assert.expect(2);
  ...
  QUnit.test('transitionTo with URL transition can be called at startup', function (assert) {
    assert.expect(2);
  ...
  QUnit.test('transitions fire a didTransition event on the destination route', function (assert) {
    assert.expect(1);
  ...
  QUnit.test('willTransition function fired before route change', function (assert) {
    assert.expect(1);
  ...
  QUnit.test('willTransition function fired with handler infos passed in', function (assert) {
    assert.expect(2);
  ...
  QUnit.test(
    'willTransition function fired with cancellable transition passed in',
    function (assert) {
      assert.expect(2);
  ...
  QUnit.test('transitions can be aborted in the willTransition event', function (assert) {
    assert.expect(3);
  ...
  QUnit.test('transitions can redirected in the willTransition event', function (assert) {
    assert.expect(2);
  ...
  QUnit.test('transitions that abort and enter into a substate', function (assert) {
    assert.expect(3);
  ...
  QUnit.test('aborted transitions can be saved and later retried', function (assert) {
    assert.expect(9);
  ...
  QUnit.test(
    'aborted transitions can be saved and later retried asynchronously',
    function (assert) {
      assert.expect(2);
  ...
  QUnit.test(
    'if an aborted transition is retried, it preserves the urlMethod of the original one',
    function (assert) {
      assert.expect(9);
  ...
  QUnit.test(
    'if an initial transition is aborted during validation phase and later retried',
    async function (assert) {
      assert.expect(7);
      ...
      try {
        ...
        shouldNotHappen(assert, 'initial transition aborted');
      } catch {
        assert.equal(currentURL, '/login', 'currentURL matches on initial transition aborted');
        assert.deepEqual(urlStack, [['replaceURL', '/login']]);

        shouldRedirectToLogin = false;
        await lastTransition!.retry();
  ...
  QUnit.test('completed transitions can be saved and later retried', function (assert) {
    assert.expect(8);
  ...
  QUnit.test('authenticated routes: starting on non-auth route', async function (assert) {
    assert.expect(8);

    setupAuthenticatedExample(assert);

    await router.transitionTo('/index');
    await transitionToWithAbort(assert, router, 'about');
    await transitionToWithAbort(assert, router, 'about');
    await transitionToWithAbort(assert, router, '/admin/about');

    // Log in. This will retry the last failed transition to 'about'.
    router.trigger('logUserIn');
  });

  QUnit.test('authenticated routes: starting on auth route', async function (assert) {
    assert.expect(8);
  ...
  QUnit.test('authenticated routes: starting on parameterized auth route', async function (assert) {
    assert.expect(5);

    setupAuthenticatedExample(assert);

    await transitionToWithAbort(assert, router, '/admin/posts/5');

    // Log in. This will retry the last failed transition to '/posts/5'.
    router.trigger('logUserIn');
  });

  QUnit.test('An instantly aborted transition fires no hooks', function (assert) {
    assert.expect(8);
  ...
  QUnit.test('transitions have a .promise property', function (assert) {
    assert.expect(2);
  ...
  QUnit.test(
    'the serialize function is bound to the correct object when called',
    function (assert) {
  ...
  QUnit.test(
    'transitionTo will soak up resolved parent models of active transition',
    function (assert) {
      assert.expect(5);
  ...
  QUnit.test(
    "transitionTo will soak up resolved all models of active transition, including present route's resolved model",
    function (assert) {
      assert.expect(2);
  ...
  QUnit.test("can reference leaf '/' route by leaf or parent name", async function (assert) {
    map(assert, function (match) {
      match('/').to('app', function (match) {
        match('/').to('index');
    ...
    await router.transitionTo('app');
    assertOnRoute('index');
    await router.transitionTo('nest');
    assertOnRoute('nest.index');
    await router.transitionTo('app');
    assertOnRoute('index');
  });

  QUnit.test('resolved models can be swapped out within afterModel', function (assert) {
    assert.expect(3);
  ...
  QUnit.test('String/number args in transitionTo are treated as url params', function (assert) {
    assert.expect(11);
  ...
  QUnit.test(
    "Transitions returned from beforeModel/model/afterModel hooks aren't treated as pausing promises",
    function (assert) {
      assert.expect(6);
 ...
 QUnit.test("exceptions thrown from model hooks aren't swallowed", function(assert) {
  assert.expect(7);
  ...
  */
  ...
  QUnit.test(
    'Transition#followRedirects() returns a promise that fulfills when any redirecting transitions complete',
    function (assert) {
      assert.expect(3);
  ...
  QUnit.test(
    'Transition#followRedirects() works correctly when redirecting from an async model hook',
    function (assert) {
      assert.expect(2);
  ...
  QUnit.test(
    "Returning a redirecting Transition from a model hook doesn't cause things to explode",
    function (assert) {
      assert.expect(2);
  ...
  QUnit.test('Generate works w queryparams', function (assert) {
  ...
  if (scenario.async) {
    QUnit.test('Generate does not invoke getHandler', function (assert) {
  ...
  QUnit.test('errors in enter/setup hooks fire `error`', function (assert) {
    assert.expect(4);
  ...
  QUnit.test(
    'invalidating parent model with different string/numeric parameters invalidates children',
    async function (assert) {
      map(assert, function (match) {
      ...
      await router.transitionTo('child', '1', '1');
      count = 1;
      await router.transitionTo('child', '2', '1');
    }
  );

  QUnit.test(
    'intents make use of previous transition state in case not enough contexts are provided to retry a transition',
    async function (assert) {
      assert.expect(3);
      ...
      await router.transitionTo('userIndex', { user: 'machty' });

      // Then attempt to transition into auth; this will redirect.
      await ignoreTransitionError(router.transitionTo('auth'));

      assert.ok(savedTransition!, 'transition was saved');

      hasAuthed = true;
      await savedTransition!.retry();

      assert.ok(didFinish, 'did enter auth route');
      assert.equal(
        (routes['user']!.context as any).user,
        'machty',
  ...
  QUnit.test('A failed transition calls the catch and finally callbacks', function (assert) {
    assert.expect(2);
  ...
  QUnit.test('A successful transition calls the finally callback', function (assert) {
    assert.expect(1);
  ...
  QUnit.test('transition sets isActive by default', function (assert) {
    assert.expect(2);
  ...
  QUnit.test('transition sets isActive to false when aborted', function (assert) {
    assert.expect(4);
  ...
  if (scenario.async) {
    QUnit.test('getHandler is invoked synchronously when returning Promises', function (assert) {
      assert.expect(2);
  ...
  QUnit.module('Multiple dynamic segments per route (' + scenario.name + ')');

  QUnit.test('Multiple string/number params are soaked up', async function (assert) {
    assert.expect(3);
    ...
    expectedUrl = '/omg/lol';
    await router.transitionTo('bar', 'omg', 'lol');

    expectedUrl = '/omg/heehee';
    await router.transitionTo('bar', 'heehee');

    expectedUrl = '/lol/no';
    await router.transitionTo('bar', 'lol', 'no');
  });

  QUnit.module('isActive (' + scenario.name + ')', {
    beforeEach: async function (assert: Assert) {
      routes = {
        parent: createHandler('parent', {
      ...
      await router.transitionTo('child', 'a', 'b', 'c', 'd');
    },
  });

  QUnit.test(
    'isActive supports multiple soaked up string/number params (via params)',
    function (assert) {
  ...
  QUnit.test(
    'isActive supports multiple soaked up string/number params (via serialized objects)',
    function (assert) {
  ...
  QUnit.test(
    'isActive supports multiple soaked up string/number params (mixed)',
    function (assert) {
  ...
  QUnit.module('Preservation of params between redirects (' + scenario.name + ')', {
    beforeEach: function (assert: Assert) {
      expectedUrl = null;
  ...
  QUnit.test("Starting on '/' root index", async function (assert) {
    await router.transitionTo('/');

    // Should call model for foo and bar
    expectedUrl = '/123/789';
    await ignoreTransitionError(router.transitionTo('barIndex', '123', '456'));
  ...
  QUnit.test("Starting on '/' root index, using redirect", async function (assert) {
  ...
  QUnit.test('Starting on non root index', async function (assert) {
    await ignoreTransitionError(router.transitionTo('/123/456'));
    assert.deepEqual(routes['foo']!.context, { id: '123' });
    assert.deepEqual(
      routes['bar']!.context,
      { id: '789' },
  ...
  /* TODO revisit
 QUnit.test("A failed handler's setup shouldn't prevent future transitions", function(assert) {
  assert.expect(2);
  ...
  */
  ...
  QUnit.test(
    "beforeModel shouldn't be refired with incorrect params during redirect",
    async function (assert) {
      ...
      await router.transitionTo('/');
      await ignoreTransitionError(router.transitionTo('peopleIndex', '1'));
    }
  );

  QUnit.module('URL-less routes (' + scenario.name + ')', {
    beforeEach: function (assert: Assert) {
      routes = {};
      expectedUrl = null;
  ...
  QUnit.test(
    "Transitioning into a route marked as inaccessibleByURL doesn't update the URL",
    function (assert) {
      assert.expect(1);
  ...
  QUnit.test(
    "Transitioning into a route with a parent route marked as inaccessibleByURL doesn't update the URL",
    async function (assert) {
      assert.expect(2);
      ...
      await router.transitionTo('/index');
      url = '/index';
      await router.transitionTo('adminPosts');
      assert.equal(url, '/index');
      await router.transitionTo('adminArticles');
      assert.equal(url, '/index');
    }
  );

  QUnit.test(
    'Handling a URL on a route marked as inaccessible behaves like a failed url match',
    function (assert) {
      assert.expect(1);
  ...
  QUnit.module('Intermediate transitions (' + scenario.name + ')', {
    beforeEach: function (assert: Assert) {
      routes = {};
      expectedUrl = null;
  ...
  QUnit.test(
    'intermediateTransitionTo() has the correct RouteInfo objects',
    async function (assert) {
      assert.expect(9);
      routes = {
      ...
      router.routeWillChange = (transition: Transition) => {
        if (enteredCount === 0) {
          ...
          assert.equal(
            transition.to!.queryParams['qux'],
            '42',
            'intermediate also has query params'
          );
      ...
      await router.transitionTo('/foo?qux=42');
    }
  );

  QUnit.test(
    "intermediateTransitionTo() forces an immediate intermediate transition that doesn't cancel currently active async transitions",
    async function (assert) {
      assert.expect(11);
  ...
  QUnit.test(
    'Calling transitionTo during initial transition in validation hook should use replaceURL',
    async function (assert) {
      assert.expect(4);
      map(assert, function (match) {
        match('/foo').to('foo');
      ...
      await ignoreTransitionError(router.transitionTo('/foo'));
  ...
  QUnit.test(
    'Calling transitionTo during initial transition in validation hook with multiple redirects should use replaceURL',
    async function (assert) {
      assert.expect(5);
      map(assert, function (match) {
        match('/foo').to('foo');
  ...
  QUnit.test(
    'Calling transitionTo after initial transition in validation hook should use updateUrl',
    async function (assert) {
      assert.expect(8);
  ...
  QUnit.test(
    'Calling transitionTo after initial transition in validation hook with multiple redirects should use updateUrl',
    async function (assert) {
      assert.expect(10);
  ...
  QUnit.test(
    'Calling replaceWith during initial transition in validation hook should use replaceURL',
    async function (assert) {
      assert.expect(4);
      map(assert, function (match) {
        match('/foo').to('foo');
  ...
  QUnit.test(
    'Calling replaceWith during initial transition in validation hook with multiple redirects should use replaceURL',
    async function (assert) {
      assert.expect(5);
      map(assert, function (match) {
        match('/foo').to('foo');
  ...
  QUnit.test(
    'Calling replaceWith after initial transition in validation hook should use updateUrl',
    async function (assert) {
      assert.expect(8);
  ...
  QUnit.test(
    'Calling replaceWith after initial transition in validation hook with multiple redirects should use updateUrl',
    async function (assert) {
      assert.expect(10);
  ...
  QUnit.test(
    'Calling replaceWith after initial replace in validation hook with multiple redirects should use replaceUrl',
    async function (assert) {
      map(assert, function (match) {
        match('/foo').to('foo');
        match('/bar').to('bar');
  ...
  QUnit.test(
    'Mixing multiple types of redirect during initial transition should work',
    async function (assert) {
      assert.expect(10);
  ...
  QUnit.test(
    'Mixing multiple types of redirects after initial transition should work',
    async function (assert) {
      assert.expect(12);
  ...
  QUnit.test(
    'Calling replaceWith after initial transition outside validation hook should use replaceURL',
    async function (assert) {
      assert.expect(7);
  ...
  QUnit.test(
    'Calling transitionTo after initial transition outside validation hook should use updateUrl',
    async function (assert) {
      assert.expect(7);
  ...
  QUnit.test(
    'transitioning to the same route with different context should not reenter the route',
    async function (assert) {
      map(assert, function (match) {
      ...
      await router.transitionTo('/project/2');
      assert.equal(
        projectEnterCount,
        1,
  ...
  QUnit.test(
    'synchronous transition errors can be detected synchronously',
    async function (assert) {
      map(assert, function (match) {
        match('/').to('root');
      });
      ...
      const transition = router.transitionTo('/');
