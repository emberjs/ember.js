...
test("should by default target the controller if no state manager exists on the controller", function() {
  ...
  Ember.$("#ember-link").click();
  equal(actionSent, true, "The action was sent to the controller");
});
