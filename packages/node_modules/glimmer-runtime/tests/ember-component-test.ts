...
import { FIXME, HasGuid, assign, installGuid } from "glimmer-util";
...
function inspect(obj: EmberObject) {
  return obj && `<#Object:${installGuid(obj)}>`;
}
...
QUnit.skip('Curly component hooks', function() {
  let instance;
...
QUnit.skip('Glimmer component hooks', function() {
  let instance;
