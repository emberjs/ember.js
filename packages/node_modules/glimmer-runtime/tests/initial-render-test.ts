...
import { TestEnvironment, normalizeInnerHTML, getTextContent, equalTokens } from "glimmer-test-helpers";
...
function render(template: Template, self: any) {
  return template.render(new UpdatableReference(self), env, { appendTo: root });
}
