...
import { FIXME, InternedString, Opaque, dict } from 'glimmer-util';
...
export type DynamicComponentFactory<T> = (args: EvaluatedArgs, env: Environment) => Reference<ComponentDefinition<T>>;
...
export class PutComponentDefinitionOpcode extends Opcode {
  ...
  evaluate(vm: VM) {
    let reference = this.factory.call(undefined, vm.frame.getArgs(), vm.env);
