...
import { BindDynamicScopeCallback } from '../vm';
...
export interface ComponentManager<T> {
  ...
  create(definition: ComponentDefinition<T>, attrs: EvaluatedNamedArgs, dynamicScope: DynamicScope): T;
  ...
  update(component: T, attrs: EvaluatedNamedArgs, dynamicScope: DynamicScope);
