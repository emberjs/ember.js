...
import { Stack, LinkedList, LOGGER, InternedString, Dict, dict, assert, installGuid } from 'glimmer-util';
...
import { Opcode, OpcodeJSON, OpSeq, UpdatingOpcode, UpdatingOpSeq } from '../opcodes';
