...
import { PublicVM, BindDynamicScopeCallback } from './vm';
...
class ComponentLayoutBuilder implements Component.ComponentLayoutBuilder {
  ...
  private callback: BindDynamicScopeCallback = null;
  ...
  compile(): CompiledBlock {
    return this.inner.compile(this.callback);
  }
...
class WrappedBuilder {
  ...
  compile(keywords: BindDynamicScopeCallback): CompiledBlock {
    let { env, layout } = this;
    ...
    if (keywords) {
      ...
      list.append(new BindDynamicScopeOpcode(keywords));
    }
...
class UnwrappedBuilder {
  ...
  compile(callback: BindDynamicScopeCallback): CompiledBlock {
    let { env, layout } = this;
    ...
    if (callback) {
      list.append(new PushDynamicScopeOpcode());
      list.append(new BindDynamicScopeOpcode(callback));
    }
