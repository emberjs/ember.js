...
class ComponentLayoutBuilder implements Component.ComponentLayoutBuilder {
  ...
  private _requiresDynamicScope: boolean = false;
  ...
  requiresDynamicScope() {
    this._requiresDynamicScope = true;
  }

  compile(): CompiledBlock {
    return this.inner.compile(this._requiresDynamicScope);
  }
...
class WrappedBuilder {
  ...
  compile(requiresDynamicScope: boolean): CompiledBlock {
    let { env, layout } = this;
