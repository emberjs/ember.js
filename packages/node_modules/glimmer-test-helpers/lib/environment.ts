...
import { FIXME, LinkedList, Slice, ListSlice, Dict, InternedString, dict } from 'glimmer-util';
...
class EmberishComponent extends GlimmerObject implements Component {
  public attrs: Attrs;
...
// class EmberishComponentManager implements ComponentManager<EmberishComponent> {
//   create(definition: EmberishComponentDefinition, args: EvaluatedNamedArgs): EmberishComponent {
//     let klass = definition.ComponentClass || EmberishComponent;
...
//   didCreate(component: EmberishComponent) {
//     component.didInsertElement();
//   }

//   update(component: EmberishComponent, args: EvaluatedNamedArgs) {
//     component.set('attrs', args.value());
//   }

//   getSelf(component: EmberishComponent) {
//     return component;
//   }
// }

// const EMBERISH_COMPONENT_MANAGER = new EmberishComponentManager();
...
export class TestEnvironment extends Environment {
  ...
  registerBasicComponent<T extends BasicComponent>(name: string, Component: BasicComponentFactory, layout: string): ComponentDefinition<T> {
    let definition = new BasicComponentDefinition(BASIC_COMPONENT_MANAGER, Component, this.compileLayout(layout));
    return this.registerComponent(name, definition);
  }

  registerEmberishComponent(name: string, Component: ComponentClass, layout: string): any {
  ...
  registerEmberishGlimmerComponent(name: string, Component: EmberishGlimmerComponentFactory, layout: string): any {
    // let testHooks = new HookIntrospection(hooks);
    let definition = new EmberishGlimmerComponentDefinition(EMBERISH_GLIMMER_COMPONENT_MANAGER, Component, this.compileLayout(layout));
    return this.registerComponent(name, definition);
  }
...
// export class HookIntrospection {
...
class EachSyntax extends StatementSyntax {
  ...
  compile(compiler: CompileInto, env: Environment) {
    ...
    compiler.append(new EvaluateOpcode({ block: this.templates.default }));
...
class RenderInverseIdentitySyntax extends StatementSyntax {
  ...
  compile(compiler: CompileInto) {
    compiler.append(new EvaluateOpcode({ block: this.templates.inverse }));
  }
}
