...
export class TestEnvironment extends Environment {
  ...
  registerBasicComponent<T extends BasicComponent>(name: string, Component: BasicComponentFactory, layout: string): ComponentDefinition<T> {
    let definition = new BasicComponentDefinition(name, BASIC_COMPONENT_MANAGER, Component, this.compileLayout(layout));
  ...
  registerEmberishCurlyComponent(name: string, Component: ComponentClass, layout: string): any {
    let definition = new EmberishCurlyComponentDefinition(name, EMBERISH_CURLY_COMPONENT_MANAGER, Component, this.compileLayout(layout));
    return this.registerComponent(name, definition);
  }

  registerEmberishGlimmerComponent(name: string, Component: EmberishGlimmerComponentFactory, layout: string): any {
    let definition = new EmberishGlimmerComponentDefinition(name, EMBERISH_GLIMMER_COMPONENT_MANAGER, Component, this.compileLayout(layout));
    return this.registerComponent(name, definition);
  }
