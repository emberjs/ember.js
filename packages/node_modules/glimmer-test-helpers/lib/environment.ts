...
export class TestEnvironment extends Environment {
  ...
  private registerComponentDefinition(name: string, Definition, manager, Factory, layout: string) : IDefinitionLookup {
  ...
  getComponentDefinition(name: InternedString[], syntax: StatementSyntax): ComponentDefinition<any> {
    ...
    if (componentLookup) {
      ...
      let componentDefinition = new Definition(name, manager, Factory, this.compileLayout(layout));
