...
export const $s0: CalleeSavedRegister.s0 = 4;
export const $s1: CalleeSavedRegister.s1 = 5;
// $6-$7 or $t0-$t1 (temporaries): caller saved general-purpose registers
export const $t0: CallerSavedRegister.t0 = 6;
export const $t1: CallerSavedRegister.t1 = 7;
...
export enum CalleeSavedRegister {
  's0' = 4,
  's1' = 5,
}

export enum CallerSavedRegister {
  't0' = 6,
  't1' = 7,
}

export type Register = MachineRegister | CalleeSavedRegister | CallerSavedRegister | typeof $v0;
export type SyscallRegister = CalleeSavedRegister | CallerSavedRegister | typeof $v0;
