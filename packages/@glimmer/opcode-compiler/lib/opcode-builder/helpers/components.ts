...
import { VM_BEGIN_COMPONENT_TRANSACTION_OP, VM_CLOSE_ELEMENT_OP, VM_COMMIT_COMPONENT_TRANSACTION_OP, VM_COMPILE_BLOCK_OP, VM_CONSTANT_OP, VM_CREATE_COMPONENT_OP, VM_DID_CREATE_ELEMENT_OP, VM_DID_RENDER_LAYOUT_OP, VM_DUP_OP, VM_FETCH_OP, VM_FLUSH_ELEMENT_OP, VM_GET_COMPONENT_LAYOUT_OP, VM_GET_COMPONENT_SELF_OP, VM_GET_COMPONENT_TAG_NAME_OP, VM_INVOKE_COMPONENT_LAYOUT_OP, VM_JUMP_UNLESS_OP, VM_LOAD_OP, VM_OPEN_DYNAMIC_ELEMENT_OP, VM_POP_DYNAMIC_SCOPE_OP, VM_POP_OP, VM_POP_SCOPE_OP, VM_POPULATE_LAYOUT_OP, VM_PREPARE_ARGS_OP, VM_PRIMITIVE_REFERENCE_OP, VM_PUSH_ARGS_OP, VM_PUSH_COMPONENT_DEFINITION_OP, VM_PUSH_DYNAMIC_COMPONENT_INSTANCE_OP, VM_PUSH_DYNAMIC_SCOPE_OP, VM_PUSH_EMPTY_ARGS_OP, VM_PUSH_SYMBOL_TABLE_OP, VM_PUT_COMPONENT_OPERATIONS_OP, VM_REGISTER_COMPONENT_DESTRUCTOR_OP, VM_RESOLVE_CURRIED_COMPONENT_OP, VM_RESOLVE_DYNAMIC_COMPONENT_OP, VM_ROOT_SCOPE_OP, VM_SET_BLOCK_OP, VM_SET_BLOCKS_OP, VM_SET_NAMED_VARIABLES_OP, VM_SET_VARIABLE_OP, VM_VIRTUAL_ROOT_SCOPE_OP } from '@glimmer/constants/lib/syscall-ops';
