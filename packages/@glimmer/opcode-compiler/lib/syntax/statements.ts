...
import { VM_CLOSE_ELEMENT_OP, VM_COMMENT_OP, VM_COMPONENT_ATTR_OP, VM_CONSTANT_REFERENCE_OP, VM_DEBUGGER_OP, VM_DUP_OP, VM_DYNAMIC_ATTR_OP, VM_DYNAMIC_CONTENT_TYPE_OP, VM_DYNAMIC_MODIFIER_OP, VM_ENTER_LIST_OP, VM_EXIT_LIST_OP, VM_FLUSH_ELEMENT_OP, VM_ITERATE_OP, VM_MODIFIER_OP, VM_OPEN_ELEMENT_OP, VM_POP_OP, VM_POP_REMOTE_ELEMENT_OP, VM_PUSH_DYNAMIC_COMPONENT_INSTANCE_OP, VM_PUSH_REMOTE_ELEMENT_OP, VM_PUT_COMPONENT_OPERATIONS_OP, VM_RESOLVE_CURRIED_COMPONENT_OP, VM_STATIC_ATTR_OP, VM_STATIC_COMPONENT_ATTR_OP, VM_TEXT_OP, VM_TO_BOOLEAN_OP } from '@glimmer/constants/lib/syscall-ops';
import { VM_INVOKE_STATIC_OP, VM_JUMP_OP, VM_POP_FRAME_OP, VM_PUSH_FRAME_OP, VM_RETURN_TO_OP } from '@glimmer/constants/lib/vm-ops';
