import { WholeProgramCompilationContext, CompileTimeResolverDelegate, CompileMode, STDLib, RuntimeProgram, Option, TemplateMeta, AnnotatedModuleLocator, Template, CompileTimeComponent } from '@glimmer/interfaces';
import { Constants, CompileTimeHeapImpl } from '@glimmer/program';
...
export default class JitCompileTimeLookup implements CompileTimeResolverDelegate {
    ...
    lookupComponent(name: string, referrer: Option<TemplateMeta<AnnotatedModuleLocator>>): Option<CompileTimeComponent>;
