...
moduleFor('Ember.Map (forEach and get are implicitly tested)', class extends AbstractTestCase {
  beforeEach() {
    object = {};
    number = 42;
    string = 'foo';
...
moduleFor('Ember.MapWithDefault (forEach and get are implicitly tested)', class extends AbstractTestCase {
  beforeEach() {
    object = {};
    number = 42;
    string = 'foo';
