...
moduleFor('computed', class extends AbstractTestCase {
  ...
  ['@test accessing computed property descriptor through the object triggers an assertion'](assert) {
    if (DESCRIPTOR_TRAP) {
...
moduleFor('computed - cacheable', class extends AbstractTestCase {
  ...
  ['@test cacheFor should return the cached value'](assert) {
  ...
  ['@test cacheFor should return falsy cached values'](assert) {
