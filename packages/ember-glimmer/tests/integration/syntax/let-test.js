...
if (EMBER_TEMPLATE_BLOCK_LET_HELPER) {
  moduleFor('Syntax test: {{#let as}}', class extends RenderingTest  {
  ...
  moduleFor('Syntax test: Multiple {{#let as}} helpers', class extends RenderingTest {
